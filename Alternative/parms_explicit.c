...
int main(int argc, char* argv[]) {
    ...
    mergeSort(array, arraySize, numThreads);
...
void mergeSort(int *arr, int arrSize, int numThreads) {
    ...
    switch (numThreads) {
        ...
        case 4: {
            ...
            // printf("aaa");                        // omg-i-was-not-setting-the-number-of-threads
            
            #pragma omp parallel num_threads(4) shared(arr)
            #pragma omp sections
            {   
                #pragma omp section
                arrDivide(arr, indexL, indexM1);
                
                #pragma omp section
                arrDivide(arr, indexM1+1, indexM2);
                
                #pragma omp section
                arrDivide(arr, indexM2+1, indexM3);
                
                #pragma omp section
                arrDivide(arr, indexM3+1, indexR);
            }
            ...
            {   
                #pragma omp section
                arrMerge(arr, indexL, indexM1, indexM2);
                
                #pragma omp section
                arrMerge(arr, indexM2+1, indexM3, indexR);
            }
        ...
        case 8: {
            ...
            {   
                ...
                #pragma omp section
                arrDivide(arr, indexM3+1, indexM4);
                
                #pragma omp section
                arrDivide(arr, indexM4+1, indexM5);
                
                #pragma omp section
                arrDivide(arr, indexM5+1, indexM6);
                
                #pragma omp section
                arrDivide(arr, indexM6+1, indexM7);
                
                #pragma omp section
                arrDivide(arr, indexM7+1, indexR);
            }
            ...
            {   
                ...
                #pragma omp section
                arrMerge(arr, indexM2+1, indexM3, indexM4);
                
                #pragma omp section
                arrMerge(arr, indexM4+1, indexM5, indexM6);
                
                #pragma omp section
                arrMerge(arr, indexM6+1, indexM7, indexR);
            }
            ...
            {   
                #pragma omp section
                arrMerge(arr, indexL, indexM2, indexM4);
                
                #pragma omp section
                arrMerge(arr, indexM4+1, indexM6, indexR);
            }
